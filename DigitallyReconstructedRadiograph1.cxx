...
{
//  boost::program_options::options_description description( "Usage DRR" );
//  description.add_options()
//      ( "help,h", "produce help message" )
//      ("verbose,v", boost::program_options::value< std::string >()->implicit_value("0"), "verbose")
//      ("spacing-x", boost::program_options::value< double >()->default_value( 1. ), "pixel spacing of the output image in x [default 1mm]")
//      ("spacing-y", boost::program_options::value< double >()->default_value( 1. ), "pixel spacing of the output image in y [default 1mm]")
//      ("size-x", boost::program_options::value< unsigned int >()->default_value( 501 ), "dimension of the output image in x [default 501]")
//      ("size-y", boost::program_options::value< unsigned int >()->default_value( 501 ), "dimension of the output image in y [default 501]")
//      ;
...
// Software Guide : EndCodeSnippet
    ...
    std::cout << rescaler->GetInputMinimum() << std::endl;
    std::cout << rescaler->GetInputMaximum() << std::endl;
    }
  else
    {
    filter->Update();
